<?php // amigos.php
	...
	for ($j = 0 ; $j < $num ; ++$j)
	{
		$row         = $result->fetch_array(MYSQLI_ASSOC); // MYSQLI_ASSOC - Os items da matriz (array) usarão o nome da coluna como uma chave de índice
	...
	$mutuos	= array_intersect($seguidores, $aseguir); // Interseção (o que é comum) de arrays para descobrir amigos mútuos
