        ...
        for ($j = 0; $j < $num; ++$j)
        {
            ...
            if ($row['tipomsg'] == 0 || $row['autor'] == $utilizador || $row['destin'] == $utilizador)
            {
                ...
                if ($resultCurtida->num_rows == 0) {
                    echo " [<a href='mensagens.php?ver=$ver&like=" . $row['id'] . "'>Curtir</a> (" . contaCurtidas($row['id']) . ")]";
                } else {
                    echo " [<a href='mensagens.php?ver=$ver&unlike=" . $row['id'] . "'>Remover curtida</a> (" . contaCurtidas($row['id']) . ")]";
                }
                echo "<br>";
            }
        }
